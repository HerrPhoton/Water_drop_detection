...
[![Docker Image Size](https://badgen.net/docker/size/alincnl/drop_detection/detect?icon=docker&label&color=cyan)](https://hub.docker.com/r/docker/alincnl/drop_detection/detect/)
